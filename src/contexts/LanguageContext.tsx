...
const translations = {
  ka: {
    // Site Meta
    'site.title': 'გრინსქეიპი – ბაღის ცენტრი და ლანდშაფტური დიზაინი',
    'site.description': 'გრინსქეიპი: ბაღის ცენტრი, ლანდშაფტური დიზაინი, დარგვა და სრული სერვისი ბაღის მოვლისთვის.',
    'brand.name': 'გრინსქეიპი',
    ...
    // Hero Section
    'hero.mission.title': 'გრინსქეიპი არის ჩვენი მისია — ჰარმონიაში გასვლა.',
    ...
    // About Section
    'about.text': 'გრინსქეიპი შპს დაარსდა 2024 წელს, როგორც "გამცვანება 94" შპს-ისა და "ახალი გამცვანება" შპს-ის ქვეკომპანია. დამფუძნებელი კომპანიების ათწლეულების გამოცდილება ახლა კერძო სექტორში გადაიტანება.',
